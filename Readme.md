...
# Configuration Script – smkdv1 - Rev. A

This **Configuration** script is designed for the **smkdv1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – smkdv1 Rev. A

Este script de **Configuration** está diseñado para el modelo **smkdv1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
